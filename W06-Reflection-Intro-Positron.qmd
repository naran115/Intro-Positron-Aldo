...
This was probably the most interesting part to me. I am primarily an R user, so I have not felt a strong need for Python support inside RStudio. But seeing that Positron treats both languages equally made me think about how that could be useful down the line as I take on more varied projects.^[For students in programs that use both R and Python, this is a meaningful advantage over RStudio where Python support has always felt like an add-on.]
...
I had not used GitHub Copilot before this assignment. After learning it was free for students through the GitHub Education program, I applied using my Cal Poly Pomona email and was accepted into the GitHub Student Developer Pack.^[The Student Developer Pack includes Copilot along with a number of other tools at no cost for verified students.]

![GitHub Education Acceptance Screenshot](screenshot-placeholder.png){#fig-copilot fig-alt="Screenshot showing GitHub Education program acceptance"}

*Replace the image above with your actual screenshot before submitting.*
...
**GitHub Pages URL:** *(Add your URL here after publishing)*
:::
